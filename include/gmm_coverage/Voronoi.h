...
float gauss3d_pdf2(gmm_msgs::Gaussian gaussian, std::vector<float> pt);
float multiple_gauss3d_pdf2(gmm_msgs::GMM gmm, std::vector<float> pt);
float single_component_pdf(gmm_msgs::Gaussian gaussian, std::vector<float> pt);
float mixture_pdf(gmm_msgs::GMM gmm, std::vector<float> pt);
std::vector<float> computeGMMPolygonCentroid2(const Diagram<double> &polygon, gmm_msgs::GMM gmm, std::vector<Box<double>> ObstacleBoxes, float discretize_precision);
...
std::vector<float> computeGMMPolygonCentroid2(const Diagram<double> &polygon, gmm_msgs::GMM gmm, std::vector<Box<double>> ObstacleBoxes = {}, float discretize_precision = 1.0/10.0){
...
template<typename T>
float calculateEffectiveness(const Diagram<T> &polygon, gmm_msgs::GMM gmm, T discretize_precision = 1.0/10.0){
...
template<typename T>
float calculateArea(const Diagram<T> &polygon, T discretize_precision = 1.0/100.0){
